...
def browseimg():
    global img
    fln = filedialog.askopenfilename(initialdir=os.getcwd(), title="Browse Imagine File", filetypes=(("JPG Image", "*.jpg"), ("PNG Image", "*.png"), ("All Files", "*.*")))
    t1.set(fln)
...
lbl4 = Label(wrapper4, text="Percentange")
